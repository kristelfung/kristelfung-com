...
Being antifragile is crucial in these times. To be antifragile is to avoid making decisions based on prediction; it is to position yourself to gain from disorder.
